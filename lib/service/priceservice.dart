...
class PriceService{
  Future<List<PriceDTO>> fetchPriceDetails(String regday) async {
    final response = await http.get(Uri.parse('http://192.168.50.248:8080/prices/saving/detail/$regday'));
  ...
  Future<List<PriceDTO>> fetchPriceTop3(String regday) async {
    final response = await http.get(Uri.parse('http://192.168.50.248:8080/prices/saving/top3/$regday'));
  ...
  Future<List<Shop>> fetchPriceIncreaseValues(String regday) async {
    final response = await http.get(Uri.parse('http://192.168.50.248:8080/prices/shopping/increase/$regday'));
  ...
  Future<List<Shop>> fetchPriceDecreaseValues(String regday) async {
    final response = await http.get(Uri.parse('http://192.168.50.248:8080/prices/shopping/decrease/$regday'));
